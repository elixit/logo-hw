...
expect(tShapes.colorToshape()).toEqual(`<circle cx="40" cy="50" r="55" fill=" fill="blue"/>`)
})

const get = require('./shapes')
let cShapes = Triangle()
test('check square color', () => {
cShapes.addColor("blue") 
expect(cShapes.colorToshape()).toEqual(`<polygon points="50,0 100,100 0,100" fill="blue"/>`)
})